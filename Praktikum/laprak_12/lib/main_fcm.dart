...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Future<void> _setupFirebaseMessaging() async {
    try {
      ...
      // 1. MENDAPATKAN TOKEN ASLI DARI SERVER FIREBASE
      ...
      // 2. LISTENER UNTUK NOTIFIKASI ASLI DARI CONSOLE (Foreground)
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        if (message.notification != null) {
          // Menampilkan SnackBar jika ada notifikasi sungguhan yang masuk
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('FCM Tanpa CLI - Annasya'),
        backgroundColor: Colors.teal,
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              // UI Estetik (Container) tetap dipertahankan
              Container(
